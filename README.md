...
The supported npm version is declared in the root `package.json` `packageManager` field and should match the npm version bundled with the Node version from `.nvmrc`.
