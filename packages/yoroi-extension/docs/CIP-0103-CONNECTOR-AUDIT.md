...
- Local request-shape validation returns code `-1` before any connector RPC; indexed per-item failures are normalized to plain CIP-30 `APIError.InvalidRequest`.
